...
def get_required_kw_args(fn):  # 所有没有默认值的(命名)关键字参数
    args = []
...
class RequestHandler(object):
    ...
    def __init__(self, app, fn):
        ...
        self._has_named_kw_args = has_named_kw_args(fn)       # 是否存在（命名）关键字参数
        self._named_kw_args = get_named_kw_args(fn)           # 所有（命名）关键字参数
        self._required_kw_args = get_required_kw_args(fn)     # 没有默认值的（命名）关键字参数
